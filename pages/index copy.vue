<template>
  <div class="container font-sans">
    ...
    <div class="main-content">
      <p class="title">Haptic Feedback Design</p>
      ...
      <div class="text-content">
        <p>
          Design your own haptic feedback! Use the orange sliders to adjust the
          behavior of the vibration motors. To add another snippet, you can
          click the + button. To delete a snippet, click and hold it. To play
          back the feedback, click on the play button.
        </p>
      </div>
    </div>
  </div>
